...
if __name__=='__main__':
    ...
    for i in [2, 5, 10, 20]:
        ...
        for j in range(3):
            ...
            run_finetune(X_train_ood, y_train_ood, X_val_ood, y_val_ood, base_mloc+str(i)+"/"+str(j)+"/", base_rloc+str(i)+"/"+str(j)+"/", model_Q=None, pretrain_loc=source_loc+str(i)+"/"+str(j)+"/", seed=j, perc_label=(0.01*i))
